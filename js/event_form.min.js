...
{silent:true})});$("input[name='description']").val(this.model.get("description"));$("input[name='description']").change(function(){self.model.set({"description":$(this).val()},{silent:true})});$("input[name='start-date']").val(this.model.get("startDate").toDateString());$("input[name='start-date']").datetimepicker({dateFormat:"mm/dd/yy",defaultDate:this.model.get("startDate"),hour:this.model.get("startDate").getHours(),minute:this.model.get("startDate").getMinutes(),second:this.model.get("startDate").getSeconds(),
onSelect:function(date){self.model.set({"startDate":Date.dateToSeconds(new Date(date))},{silent:true})}});$("input[name='end-date']").val(this.model.get("endDate").toDateString());$("input[name='end-date']").datetimepicker({dateFormat:"mm/dd/yy",defaultDate:this.model.get("endDate"),minDate:this.model.get("starDate"),hour:this.model.get("endDate").getHours(),minute:this.model.get("endDate").getMinutes(),second:this.model.get("endDate").getSeconds(),onSelect:function(date){self.model.set({"endDate":Date.dateToSeconds(new Date(date))},
