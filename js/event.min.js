...
$("#event-user").html("<span class='gray-text'>Created by</span> <span class='icon-user'></span><a href='#'>"+this.model.get("author")+"</a> <span class='gray-text'>on</span> "+(new Date(this.model.get("startDate"))).toDateString());$("#map-label").html("<span class='icon-location'></span>"+this.model.get("location").name)},reset:function(date){var self=this;this.timestamp=date;this.update()},update:function(){switch(this.model.get("status")){case 1:$("#timeline-label").html("<span class='icon-time'></span>Live, "+
this.formatTime(new Date-this.timestamp));break;case 2:$("#timeline-label").html("<span class='icon-time'></span>Archived event.");break;case -1:$("#timeline-label").html("<span class='icon-time'></span>Stopping event tracking...");break;case 0:$("#timeline-label").html("<span class='icon-time'></span>Initializing event tracking...");break}},formatTime:function(milliseconds){var seconds=Math.floor(milliseconds/1E3);var minutes=Math.floor(milliseconds/6E4);var hours=Math.floor(milliseconds/36E5);var days=
