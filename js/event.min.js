...
itm.html.find("#load-itm").show()},deleteItem:function(itm){itm.html.fadeOut();this.model.remove(itm.model,{silent:true})},approveItem:function(itm,value){this.disableItem(itm);var self=this;if(value===undefined)value=itm.model.get("status")===1?0:1;else value=value===true?1:0;itm.model.set({status:value.toString()});itm.model.save({error:function(){console.log("Error updating model");self.enableItem(itm);self.showHidePending(itm)},success:function(){self.showHidePending(itm);self.enableItem(itm);
