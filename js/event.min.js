...
getItemCount:function(group){return group.get("stats").total}});SIVVIT.MapView=Backbone.View.extend({el:"#map-container",render:function(name,lon,lat){$(this.el).html('<img src="http://maps.googleapis.com/maps/api/staticmap?center='+lon+","+lat+'&zoom=10&size=280x130&sensor=false">')}});SIVVIT.HeaderView=Backbone.View.extend({timestamp:null,render:function(){$("#event-title").html(this.model.get("title"));$("#event-description").html(this.model.get("description"));$("#event-user").html("<span class='gray-text'>Created by</span> <span class='icon-user'></span><a href='#'>"+
