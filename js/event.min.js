(function(){$("#new-event").fancybox({"width":860,"height":430,"autoScale":true,"scrolling":false,"transitionIn":"fade","transitionOut":"fade","type":"iframe"})})();if(typeof SIVVIT=="undefined")SIVVIT={};Date.prototype.format=function(){return this.getMonth()+1+"/"+this.getDate()+"/"+this.getFullYear()+" "+this.getHours()+":"+this.getMinutes()+":"+this.getSeconds()};
