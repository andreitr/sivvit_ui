...
"s<span class='icon-download'></span></div>");btn=$("#load-groups-btn");btn.waypoint(function(event,direction){console.log(event,direction);btn.waypoint("remove");btn.html("<span class='loader'>&nbsp;</span>");self.display_buckets=true;self.eventModel.loadMoreContent()},{offset:"100%"})}},showLoader:function(show){$(this.el).empty();$(this.el).html("<div id='content-loader'></div>")},buildTemplate:function(itm){var html;switch(itm.get("type")){case "photo":html=$.tmpl(this.photo_template,{thumbnail:itm.get("thumbnail"),
