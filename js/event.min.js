...
this.model.get("max");var minVal=this.model.get("min");var maxHeight=$(this.el).height();var maxWidth=$(this.el).width();var barW=$(this.el).width()/lenTotal;barW=barW<0.5?0.5:barW;var startTime=this.model.get("histogramStartDate");var endTime=adjusted_end_date;var histogram=Raphael($(this.el)[0],$(this.el).width(),$(this.el).height());for(var i=len;i--;){var frame=new SIVVIT.TemporalFrameModel(this.model.get("histogram")[i]);var percentY=frame.get("count")/maxVal*100;var percentX=(frame.get("timestamp").getTime()-
startTime)/(endTime-startTime);var barH=Math.round(percentY*maxHeight/100);var barX=Math.round(percentX*maxWidth);var barY=Math.round(maxHeight-barH);var bar=histogram.rect(barX,barY,barW,barH).attr({fill:"#333333","stroke-width":0});if(this.slider){bar.timestamp=frame.get("timestamp");this.updateBarColor(bar);this.bars.push(bar)}}}}});