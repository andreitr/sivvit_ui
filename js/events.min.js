...
min:itm.model.get("histogram").min,max:itm.model.get("histogram").max,resolution:itm.model.get("histogram").resolution,histogram:itm.model.get("histogram").global})})).render();this.initItem(itm,"#event-list")},this);this.initLightbox()},buildTemplate:function(itm){var html=$.tmpl(this.template,{title:itm.get("title"),description:itm.get("description"),posts:itm.get("stats").posts,videos:itm.get("stats").videos,images:itm.get("stats").images,location:itm.get("location").name,author:itm.get("author")});
return{html:html,model:itm}},initItem:function(itm,parent){var self=this;if(itm!==null){if(this.edit){itm.html.find("#content").prepend('<span class="item-edit"><span class="icon-delete" id="del-itm"></span><span class=\'icon-cog\' href="event_form.html?id='+itm.model.get("id")+'" id=\'edit-itm\'></span><div id="pending-flag"></div></span>');itm.html.find("#content").prepend('<div id="checkbox"><input type="checkbox" id="itm-check"/></div>');itm.html.find("#del-itm").hide();itm.html.find("#edit-itm").hide();
