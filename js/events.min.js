...
attributes,options);return this},createEvent:function(init){var self=this;$.ajax({url:"http://sivvit.com/e/event/",data:self.formatModel(),type:"POST",dataType:"json",success:init.success,complete:init.complete,error:init.error})},updateEvent:function(){var self=this;$.ajax({url:"http://sivvit.com/e/event/"+this.get("id"),data:self.formatModel(),type:"PUT",dataType:"json"})},formatModel:function(){var result={startDate:Date.dateToSeconds(this.get("startDate")),endDate:Date.dateToSeconds(this.get("endDate")),
