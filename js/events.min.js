if(typeof SIVVIT=="undefined")SIVVIT={};SIVVIT.Settings={host:"http://sivvit.com"};(function(jQuery,SIVVIT){SIVVIT.Events={collection:null,view:null,edit:true,init:function(json){var self=this;this.collection=new SIVVIT.EventsCollection;this.view=new SIVVIT.EventsView({edit:this.edit});$.getJSON(json,function(data){$("#content-loader").remove();$("#event-application").show();var len=data.length,i;for(i=len;i--;){var model=new SIVVIT.EventModel(data[i]);model.set({timestamp:Date.secondsToDate(data[i])});self.collection.add(model)}self.view.model=self.collection;self.view.render()})}};
